...
public extension KeyTransformer {
    public static func carbonToCocoaFlags(_ carbonFlags: Int) -> NSEventModifierFlags {
    ...
    public static func cocoaToCarbonFlags(_ cocoaFlags: NSEventModifierFlags) -> Int {
    ...
    public static func singleCocoaFlags(_ cocoaFlags: NSEventModifierFlags) -> Bool {
        ...
        let altSelected     = cocoaFlags.contains(.option)
